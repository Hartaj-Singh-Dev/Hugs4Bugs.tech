	 ...
	 <section className='w-screen mt-20 flex justify-center items-center'>
		 <article className=" w-5/6 max-w-5/6 sm:w-1/2">
			 <h1 className="text-white font-['Ubuntu'] text-3xl sm:text-6xl md:text-8xl font-extrabold">{frontmatter.title}</h1> 
			  <div className=" mt-10 font-['Inconsolata'] font-light opacity-80 text-lg leading-8 text-white" dangerouslySetInnerHTML={{ __html : marked(content)}}></div>
		 </article>
	 </section>
	 <section className='w-full justify-items-center items-center'>
       <div className="utterances" style={{height:"70rem"}}>
